<?php
// source: /Users/BugsBunny/WWW/_bugs-nette-skel/app/config/config.neon 
// source: /Users/BugsBunny/WWW/_bugs-nette-skel/app/config/config.local.neon 
...
class SystemContainer extends Nette\DI\Container
{
	...
	public function __construct()
	{
		parent::__construct(array(
			'appDir' => '/Users/BugsBunny/WWW/_bugs-nette-skel/app',
			'wwwDir' => '/Users/BugsBunny/WWW/_bugs-nette-skel',
			'debugMode' => TRUE,
			...
			'tempDir' => '/Users/BugsBunny/WWW/_bugs-nette-skel/app/../temp',
		));
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('/Users/BugsBunny/WWW/_bugs-nette-skel/app/../temp/cache', $this->getService('nette.cacheJournal'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileJournal('/Users/BugsBunny/WWW/_bugs-nette-skel/app/../temp');
		return $service;
	}
	...
	public function createServiceNette__latte()
	{
		...
		$service->setTempDirectory('/Users/BugsBunny/WWW/_bugs-nette-skel/app/../temp/cache/latte');
	...
	{
		$service = new Nette\Application\PresenterFactory('/Users/BugsBunny/WWW/_bugs-nette-skel/app', $this);
	...
	{
		$service = new Nette\Caching\Storages\PhpFileStorage('/Users/BugsBunny/WWW/_bugs-nette-skel/app/../temp/cache', $this->getService('nette.cacheJournal'));
